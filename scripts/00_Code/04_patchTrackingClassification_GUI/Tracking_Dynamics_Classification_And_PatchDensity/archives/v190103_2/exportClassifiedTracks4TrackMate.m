function exportClassifiedTracks4TrackMate(imgFilename,pathImg,lstTraj,traj2Cell,pixSize,lagTime,tabForBS,cellDescription)
...
nSpot=get_nSpot(lstTraj,traj2Cell_select);
line=strcat(['    <AllSpots nspots="',num2str(nSpot),'">']);
fprintf(fDest, '%s\n', line);
disp('XML: edit spot features');
[traj2spot,spotSpec]=editXML_spot(fDest,lstTraj,traj2Cell_select,nSpot, nFrame,pixSize,lagTime);
disp('XML: edit track/edge features');
editXML_tracks(fDest,lstTraj,traj2Cell_select,traj2spot,spotSpec,lagTime,pixSize,tabForBS,cellDescription);
...
function nSpot=get_nSpot(lstTraj,traj2Cell)
nSpot=0;
nTraj=numel(lstTraj);
for iTraj=1:nTraj
...
function [traj2spot,spotSpec]=editXML_spot(fDest,lstTraj,traj2Cell,nSpot, nFrame,pixSize,lagTime)

traj2spot=edit_traj2spot(lstTraj,traj2Cell,nFrame);
[spotSpec]=eval_spotSpec(lstTraj,traj2Cell,traj2spot,nSpot,pixSize,lagTime);
...
function traj2spot=edit_traj2spot(lstTraj,traj2Cell,nFrame)
nTraj=numel(lstTraj);
...
function [spotSpec]=eval_spotSpec(lstTraj,traj2Cell,traj2spot,nSpot,pixSize,lagTime)
nSpecParam=21;
...
function editXML_tracks(fDest,lstTraj,traj2Cell,traj2spot,spotSpec,lagTime,pixSize,tabForBS,cellDescription)
nTraj=numel(lstTraj);
[trajSpec,lstTrajExport]=eval_trajSpec(lstTraj,traj2Cell,traj2spot,lagTime,pixSize,tabForBS,cellDescription);
...
function [trajSpec,lstTrajExport]=eval_trajSpec(lstTraj,traj2Cell,traj2spot,lagTime,pixSize,tabForBS,cellDescription)
