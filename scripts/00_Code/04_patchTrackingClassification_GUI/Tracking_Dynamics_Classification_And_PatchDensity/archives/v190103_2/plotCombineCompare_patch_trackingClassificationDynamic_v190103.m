function plotCombineCompare_patch_trackingClassificationDynamic_v190103()
...
while (defineNewLst>0)
    ...
    nCond=nCond+1;
    compil_patchDensityDyn=[compil_patchDensityDyn;tab_patchDensityDyn,nCond*ones(size(tab_patchDensityDyn,1),1)];
    compil_patchDynamic=[compil_patchDynamic;tab_patchDynamic,nCond*ones(size(tab_patchDynamic,1),1)];
