function exportClassifiedTracksSelected4TrackMate(imgFilename,pathImg,lstTraj,traj2Cell,pixSize,lagTime,tabForBS,cellDescription,displayParams)
...
nSpot=get_nSpot_Sel(lstTraj,traj2Cell_select,tabKeep);
line=strcat(['    <AllSpots nspots="',num2str(nSpot),'">']);
fprintf(fDest, '%s\n', line);
disp('XML: edit spot features');
[traj2spot,spotSpec]=editXML_spot_Sel(fDest,lstTraj,traj2Cell_select,nSpot, nFrame,pixSize,lagTime,tabKeep);
disp('XML: edit track/edge features');
editXML_tracks_Sel(fDest,lstTraj,traj2Cell_select,traj2spot,spotSpec,lagTime,pixSize,tabForBS,tabKeep);
...
function nSpot=get_nSpot_Sel(lstTraj,traj2Cell_select,tabKeep)
nSpot=0;
nTraj=numel(lstTraj);
for iTraj=1:nTraj
...
function [traj2spot,spotSpec]=editXML_spot_Sel(fDest,lstTraj,traj2Cell_select,nSpot, nFrame,pixSize,lagTime,tabKeep)

traj2spot=edit_traj2spot_Sel(lstTraj,traj2Cell_select,nFrame,tabKeep);
[spotSpec]=eval_spotSpec(lstTraj,traj2Cell_select,traj2spot,nSpot,pixSize,lagTime);
...
function traj2spot=edit_traj2spot_Sel(lstTraj,traj2Cell_select,nFrame,tabKeep)
nTraj=numel(lstTraj);
...
function [spotSpec]=eval_spotSpec(lstTraj,traj2Cell_select,traj2spot,nSpot,pixSize,lagTime)
nSpecParam=21;
...
function editXML_tracks_Sel(fDest,lstTraj,traj2Cell_select,traj2spot,spotSpec,lagTime,pixSize,tabForBS,tabKeep)
nTraj=numel(lstTraj);
[trajSpec,lstTrajExport]=eval_trajSpec_Sel(lstTraj,traj2Cell_select,traj2spot,lagTime,pixSize,tabForBS,tabKeep);
...
function [trajSpec,lstTrajExport]=eval_trajSpec_Sel(lstTraj,traj2Cell_select,traj2spot,lagTime,pixSize,tabForBS,tabKeep)
