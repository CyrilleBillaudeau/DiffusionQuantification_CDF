function run_patch_trackingClassificationDynamic_v190403(lstFiles)
%clear all
...
for iFile=1:nFile
    ...
    if (exist(path_resUTrack,'dir')==7)        
        ...
        if (doTrackMateExport)
            exportClassifiedTracks4TrackMate(imgFilename,pathImg,lstTraj,traj2Cell,pixSize,lagTime,tabForBS,cellDescription);
        end%if
