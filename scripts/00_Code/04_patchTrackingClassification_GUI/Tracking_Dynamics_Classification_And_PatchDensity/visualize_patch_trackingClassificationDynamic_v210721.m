function visualize_patch_trackingClassificationDynamic_v210721(displayParams,trackingMethod)
...
if (importDone)        
    ...
    [cellMask,nCell,cellDescription,tab_cellID_convert]=getCellMask_Specifications(imgFilename,pixSize);
    
    %% associate traj to cell
    traj2Cell=trajCell_associate(all_tr,nTraj,cellDescription,nCell,cellMask);
    
    %% Load MSD analysis results
    ...
    exportClassifiedTracksSelected4TrackMate(imgFilename,pathImg,all_tr,traj2Cell,pixSize,lagTime,tabForBS,cellDescription,displayParams);
